...
testplotKM <- function(){
    ...
    lrs.obj <- new("ModelLinear", coefficients=lrs, modeltype="compoundcovariate")
    ...
    # modeltype optional
    lrs.obj <- new("ModelLinear", coefficients=lrs)
    ret.survhd <- plot(lrs.obj, newdata=X, newy=y, show.n.risk=FALSE)
